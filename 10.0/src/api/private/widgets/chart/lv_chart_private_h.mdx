...
| `series_ll` | <ApiLink name="lv_ll_t" /> | Linked list for series (stores lv_chart_series_t) |
| `cursor_ll` | <ApiLink name="lv_ll_t" /> | Linked list for cursors (stores lv_chart_cursor_t) |
| `ymin` | `int32_t[2]` |  |
| `ymax` | `int32_t[2]` |  |
| `xmin` | `int32_t[2]` |  |
| `xmax` | `int32_t[2]` |  |
