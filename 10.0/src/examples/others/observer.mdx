...
## PIN login via state observers

<LvglExampleBrief>Decouple a login UI from an engine subject using observers on an auth subject.</LvglExampleBrief>
...
<LvglExampleBrief>Aggregate hour, minute, format, and AM/PM subjects into one group subject.</LvglExampleBrief>
