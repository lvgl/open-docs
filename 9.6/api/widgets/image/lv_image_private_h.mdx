...
| `src_type` | <ApiLink name="uint32_t" /> | See: lv_image_src_t |
...
| `align` | <ApiLink name="uint32_t" /> | Image size mode when image size and object size is different. See lv_image_align_t |
