...
<ApiSummary functions={21} enums={1} typedefs={1} />
...
<ApiMember kind="function" name="lv_event_desc_set_external_data" file="public/core/lv_event.h" line={287} url="https://github.com/lvgl/lvgl/tree/e120c31bda473522cc475617fd321ee98191f0d4/include/lvgl/core/lv_event.h#L287">
...
| `data` | `void *` | pointer to the external data to associate with the event descriptor **May** be `NULL`. |
| `free_cb` | `void(*)(void *data)` | function pointer to a destructor that will be called to clean up the external data. The destructor will receive the data pointer as its parameter. **May** be `NULL`. When NULL no cleanup is performed. |
...
<ApiMember kind="function" name="lv_event_get_count" file="public/core/lv_event.h" line={175} url="https://github.com/lvgl/lvgl/tree/e120c31bda473522cc475617fd321ee98191f0d4/include/lvgl/core/lv_event.h#L175">
...
<ApiMember kind="function" name="lv_event_get_dsc" file="public/core/lv_event.h" line={177} url="https://github.com/lvgl/lvgl/tree/e120c31bda473522cc475617fd321ee98191f0d4/include/lvgl/core/lv_event.h#L177">
...
<ApiMember kind="function" name="lv_event_dsc_get_cb" file="public/core/lv_event.h" line={179} url="https://github.com/lvgl/lvgl/tree/e120c31bda473522cc475617fd321ee98191f0d4/include/lvgl/core/lv_event.h#L179">
...
<ApiMember kind="function" name="lv_event_dsc_get_user_data" file="public/core/lv_event.h" line={181} url="https://github.com/lvgl/lvgl/tree/e120c31bda473522cc475617fd321ee98191f0d4/include/lvgl/core/lv_event.h#L181">
...
<ApiMember kind="function" name="lv_event_get_target" file="public/core/lv_event.h" line={192} url="https://github.com/lvgl/lvgl/tree/e120c31bda473522cc475617fd321ee98191f0d4/include/lvgl/core/lv_event.h#L192">
...
<ApiMember kind="function" name="lv_event_get_current_target" file="public/core/lv_event.h" line={200} url="https://github.com/lvgl/lvgl/tree/e120c31bda473522cc475617fd321ee98191f0d4/include/lvgl/core/lv_event.h#L200">
...
<ApiMember kind="function" name="lv_event_get_code" file="public/core/lv_event.h" line={207} url="https://github.com/lvgl/lvgl/tree/e120c31bda473522cc475617fd321ee98191f0d4/include/lvgl/core/lv_event.h#L207">
...
<ApiMember kind="function" name="lv_event_get_param" file="public/core/lv_event.h" line={214} url="https://github.com/lvgl/lvgl/tree/e120c31bda473522cc475617fd321ee98191f0d4/include/lvgl/core/lv_event.h#L214">
...
<ApiMember kind="function" name="lv_event_get_user_data" file="public/core/lv_event.h" line={221} url="https://github.com/lvgl/lvgl/tree/e120c31bda473522cc475617fd321ee98191f0d4/include/lvgl/core/lv_event.h#L221">
...
<ApiMember kind="function" name="lv_event_code_get_name" file="public/core/lv_event.h" line={273} url="https://github.com/lvgl/lvgl/tree/e120c31bda473522cc475617fd321ee98191f0d4/include/lvgl/core/lv_event.h#L273">
...
<ApiMember kind="function" name="lv_event_send" file="public/core/lv_event.h" line={158} url="https://github.com/lvgl/lvgl/tree/e120c31bda473522cc475617fd321ee98191f0d4/include/lvgl/core/lv_event.h#L158">
...
| Name | Type | Description |
|------|------|-------------|
| `list` | <ApiLink name="lv_event_list_t" display="lv_event_list_t *" /> | pointer to an event list. **May** be `NULL`. When NULL there is nothing to notify and LV_RESULT_OK is returned. Widgets without `spec_attr` legitimately have no list. |
| `e` | <ApiLink name="lv_event_t" display="lv_event_t *" /> | pointer to the event to send |
| `preprocess` | `bool` | true: send only to the preprocess callbacks |

**Returns:** <ApiLink name="lv_result_t" /> — LV_RESULT_OK: the target wasn't deleted in the event


</ApiMember>

<ApiMember kind="function" name="lv_event_add" file="public/core/lv_event.h" line={171} url="https://github.com/lvgl/lvgl/tree/e120c31bda473522cc475617fd321ee98191f0d4/include/lvgl/core/lv_event.h#L171">
...
| Name | Type | Description |
|------|------|-------------|
| `list` | <ApiLink name="lv_event_list_t" display="lv_event_list_t *" /> | pointer to an event list |
| `cb` | <ApiLink name="lv_event_cb_t" /> | the callback to invoke when a matching event is sent |
| `filter` | <ApiLink name="lv_event_code_t" /> | event code to react to |
| `user_data` | `void *` | custom pointer stored with the callback and retrievable inside it via <ApiLink name="lv_event_get_user_data" display="lv_event_get_user_data()" />. **May** be `NULL`.. |

**Returns:** <ApiLink name="lv_event_dsc_t" display="lv_event_dsc_t *" /> — pointer to the newly created event descriptor, or `NULL` on failure. Can be passed to <ApiLink name="lv_event_remove_dsc" display="lv_event_remove_dsc()" /> later.


</ApiMember>

<ApiMember kind="function" name="lv_event_remove_dsc" file="public/core/lv_event.h" line={173} url="https://github.com/lvgl/lvgl/tree/e120c31bda473522cc475617fd321ee98191f0d4/include/lvgl/core/lv_event.h#L173">
...
<ApiMember kind="function" name="lv_event_remove" file="public/core/lv_event.h" line={183} url="https://github.com/lvgl/lvgl/tree/e120c31bda473522cc475617fd321ee98191f0d4/include/lvgl/core/lv_event.h#L183">
...
<ApiMember kind="function" name="lv_event_remove_all" file="public/core/lv_event.h" line={185} url="https://github.com/lvgl/lvgl/tree/e120c31bda473522cc475617fd321ee98191f0d4/include/lvgl/core/lv_event.h#L185">
...
<ApiMember kind="function" name="lv_event_stop_bubbling" file="public/core/lv_event.h" line={228} url="https://github.com/lvgl/lvgl/tree/e120c31bda473522cc475617fd321ee98191f0d4/include/lvgl/core/lv_event.h#L228">
...
<ApiMember kind="function" name="lv_event_stop_trickling" file="public/core/lv_event.h" line={235} url="https://github.com/lvgl/lvgl/tree/e120c31bda473522cc475617fd321ee98191f0d4/include/lvgl/core/lv_event.h#L235">
...
<ApiMember kind="function" name="lv_event_stop_processing" file="public/core/lv_event.h" line={242} url="https://github.com/lvgl/lvgl/tree/e120c31bda473522cc475617fd321ee98191f0d4/include/lvgl/core/lv_event.h#L242">
...
<ApiMember kind="function" name="lv_event_free_user_data_cb" file="public/core/lv_event.h" line={249} url="https://github.com/lvgl/lvgl/tree/e120c31bda473522cc475617fd321ee98191f0d4/include/lvgl/core/lv_event.h#L249">
...
<ApiMember kind="function" name="lv_event_register_id" file="public/core/lv_event.h" line={266} url="https://github.com/lvgl/lvgl/tree/e120c31bda473522cc475617fd321ee98191f0d4/include/lvgl/core/lv_event.h#L266">
...
**Returns:** `uint32_t` — the new event id, or `LV_EVENT_LAST` if `LV_EVENT_LAST_CUSTOM` is reached
...
<ApiMember kind="enum" name="lv_event_code_t" file="public/core/lv_event.h" line={34} url="https://github.com/lvgl/lvgl/tree/e120c31bda473522cc475617fd321ee98191f0d4/include/lvgl/core/lv_event.h#L34">
...
| `LV_EVENT_LAST` |  |  |
| `LV_EVENT_LAST_CUSTOM` | `0x7FFF` | Number of default events |
| `LV_EVENT_PREPROCESS` | `0x8000` | Sentinel for the last custom event code |
...
<ApiMember kind="typedef" name="lv_event_cb_t" file="public/core/lv_event.h" line={29} url="https://github.com/lvgl/lvgl/tree/e120c31bda473522cc475617fd321ee98191f0d4/include/lvgl/core/lv_event.h#L29">
...
<FileIncludes
  includes={["lv_types.h", "lv_conf_internal.h"]}
