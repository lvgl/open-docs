...
<ApiMember kind="function" name="lv_vector_for_each_destroy_tasks" file="private/draw/lv_draw_vector_private.h" line={131} url="https://github.com/lvgl/lvgl/tree/1c71f15c945c9521cc85aaf9fd7a92e994a69c91/src/draw/lv_draw_vector_private.h#L131">
...
| `user_data` | `void *` | a custom pointer that will be passed to the callback **Optional:** may be `NULL`. |
