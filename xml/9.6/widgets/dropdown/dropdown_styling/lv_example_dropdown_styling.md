```xml title="examples/widgets/dropdown/dropdown_styling/lv_example_dropdown_styling.xml" source="https://github.com/lvgl/lvgl/blob/99df9b9ac7b096ca30802f8d3a12452b78bc9110/examples/widgets/dropdown/dropdown_styling/lv_example_dropdown_styling.xml"
<!--
...
<screen>
	<styles>
		...
		<style name="style_dropdown_main"
			bg_opa="100%" bg_color="0xffffff"
			radius="10"
			border_color="0xd1d5db" border_width="2"
			text_color="0x111827"
			pad_left="14" pad_right="14" pad_top="10" pad_bottom="10" />
		<!-- Main button, focused: accent border + halo -->
		<style name="style_dropdown_focused"
			border_color="0x6366f1"
			outline_color="0x6366f1" outline_width="3" outline_pad="2" outline_opa="120" />
	</styles>
