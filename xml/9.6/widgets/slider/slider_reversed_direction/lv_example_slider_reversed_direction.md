```xml title="examples/widgets/slider/slider_reversed_direction/lv_example_slider_reversed_direction.xml" source="https://github.com/lvgl/lvgl/blob/829c7a22191e5dc0aceba71c54c09f42c08e3ac5/examples/widgets/slider/slider_reversed_direction/lv_example_slider_reversed_direction.xml"
<!--
...
<screen>
	...
	<view flex_flow="column" style_flex_main_place="center" style_flex_cross_place="center" style_flex_track_place="center" style_pad_row="16">
		...
		<lv_slider name="slider_1" width="90%" height="16" min_value="0" max_value="100" value="30">
			<lv_label name="label_1" align="center" text="0..100" style_text_color="#text_color" />
		</lv_slider>

		<!-- Reverse direction: range 100..0 -->
		<lv_slider name="slider_2" width="90%" height="16" min_value="100" max_value="0" value="30">
