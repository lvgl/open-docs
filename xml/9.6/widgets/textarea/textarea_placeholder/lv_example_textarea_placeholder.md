```xml title="examples/widgets/textarea/textarea_placeholder/lv_example_textarea_placeholder.xml" source="https://github.com/lvgl/lvgl/blob/18760b7f0312f8a7e13147f2ca83cd10710438c1/examples/widgets/textarea/textarea_placeholder/lv_example_textarea_placeholder.xml"
<!--
...
<screen>
	<view flex_flow="column" style_flex_main_place="center" style_flex_cross_place="center" style_flex_track_place="center" style_pad_row="16">
		...
		<lv_textarea name="textarea_1" width="90%" one_line="true" placeholder_text="Search…" />

		<!-- Filled: placeholder is hidden -->
		<lv_textarea name="textarea_2" width="90%" one_line="true" placeholder_text="Search…" text="lv_textarea" />
	</view>
</screen>
```
