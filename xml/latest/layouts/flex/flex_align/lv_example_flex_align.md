```xml title="examples/layouts/flex/flex_align/lv_example_flex_align.xml" source="https://github.com/lvgl/lvgl/blob/406fe8cb912436be179698d9603cef5948692dbc/examples/layouts/flex/flex_align/lv_example_flex_align.xml"
<!--
 @title Flex align
...
<screen>
	<view flex_flow="column" style_flex_main_place="center" style_flex_cross_place="center" style_flex_track_place="center">
		...
		>
			...
			<lv_button name="button" height="64">
			...
			<lv_checkbox name="checkbox" text="Check" />
		</lv_obj>
	</view>
</screen>
```
