```xml title="examples/styles/style_text/lv_example_style_text.xml" source="https://github.com/lvgl/lvgl/blob/829c7a22191e5dc0aceba71c54c09f42c08e3ac5/examples/styles/style_text/lv_example_style_text.xml"
<!--
 @title Text styling
...
<screen>
	...
	<styles>
		...
		<style name="style_card"
			...
			border_width="1" border_color="0xe2e8f0" pad_all="22" />
	...
	<view flex_flow="column" style_flex_main_place="center" style_flex_cross_place="center" style_flex_track_place="center" style_pad_row="16">
		...
		<lv_obj name="container" width="240" height="content">
			<style name="style_card" />
			<lv_label name="label" align="center" style_text_align="center" text="Modern&#10;Typography">
				<style name="style_heading" />
			</lv_label>
		</lv_obj>
	</view>
