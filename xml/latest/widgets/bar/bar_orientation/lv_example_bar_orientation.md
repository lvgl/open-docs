```xml title="examples/widgets/bar/bar_orientation/lv_example_bar_orientation.xml" source="https://github.com/lvgl/lvgl/blob/829c7a22191e5dc0aceba71c54c09f42c08e3ac5/examples/widgets/bar/bar_orientation/lv_example_bar_orientation.xml"
<!--
...
<screen>
	...
	<view flex_flow="column" style_flex_main_place="center" style_flex_cross_place="center" style_flex_track_place="center" style_pad_row="16">
		...
		<lv_bar name="bar_1" width="90%" height="16" min_value="0" max_value="100" value="60">
			<lv_label name="label_1" align="center" text="horizontal" style_text_color="#text_color" />
		</lv_bar>

		<!-- Explicit vertical orientation -->
		<lv_bar name="bar_2" width="18" height="130" orientation="vertical" min_value="0" max_value="100" value="60">
