```xml title="examples/widgets/bar/bar_value_range/lv_example_bar_value_range.xml" source="https://github.com/lvgl/lvgl/blob/f92d9d2829dd66417588a4e4199bc46060d4e67b/examples/widgets/bar/bar_value_range/lv_example_bar_value_range.xml"
<!--
...
<screen>
	...
	<view flex_flow="column" style_flex_main_place="center" style_flex_cross_place="center" style_flex_track_place="center" style_pad_row="16">
		...
		<!-- Default 0..100 range -->
		<lv_bar name="bar_1" width="90%" height="16" min_value="0" max_value="100" value="30">
			<lv_label name="label_1" align="center" text="0..100" style_text_color="#text_color" />
		</lv_bar>

		<!-- Custom range that does not start at zero -->
		<lv_bar name="bar_2" width="90%" height="16" min_value="-20" max_value="80" value="35">
