```xml title="examples/widgets/chart/chart_scrollable/lv_example_chart_scrollable.xml" source="https://github.com/lvgl/lvgl/blob/406fe8cb912436be179698d9603cef5948692dbc/examples/widgets/chart/chart_scrollable/lv_example_chart_scrollable.xml"
<!--
...
<screen>
	<view flex_flow="column" style_flex_main_place="center" style_flex_cross_place="center" style_flex_track_place="center" style_pad_row="16">
		...
		<lv_obj name="container_1" width="220" height="180" style_pad_all="0">
			<!-- Wrapper: wider than the viewport so it scrolls. Hosts both chart and scale stacked vertically. -->
			<lv_obj name="container_2" width="300%" height="100%" flex_flow="column" style_bg_opa="0" style_border_width="0" style_pad_all="4">
				<lv_chart name="chart" width="100%" flex_grow="1"
					type="bar" point_count="12"
					hor_div_line_count="3" ver_div_line_count="0">
				...
				<lv_scale name="scale" width="100%" height="22"
					mode="horizontal_bottom"
					total_tick_count="12" major_tick_every="1"
					label_show="true"
