```xml title="examples/widgets/spinbox/spinbox_format/lv_example_spinbox_format.xml" source="https://github.com/lvgl/lvgl/blob/f92d9d2829dd66417588a4e4199bc46060d4e67b/examples/widgets/spinbox/spinbox_format/lv_example_spinbox_format.xml"
<!--
...
<screen>
	<view flex_flow="column" style_flex_main_place="center" style_flex_cross_place="center" style_flex_track_place="center" style_pad_row="16">
		...
		<lv_spinbox name="spinbox_1" width="160"
			digit_count="3"
			value="123"
			dec_point_pos="0"
			step="1" />
		...
		<lv_spinbox name="spinbox_2" width="160"
			digit_count="5"
			value="123"
			dec_point_pos="2"
			step="1" />
